...
from app.services.recommendations.rules import Draft, dish_drafts, weekday_draft
...
class RecommendationEngine:
    ...
    async def generate_for(self, restaurant_id: uuid.UUID, for_date: date) -> int:
        ...
        drafts: list[Draft] = dish_drafts(dishes.top + dishes.bottom)
        if best and worst and (wd := weekday_draft(best, worst)) is not None:
            drafts.append(wd)
